...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/09/11 12:15:12 by vfuster-          #+#    #+#             */
/*   Updated: 2023/09/14 07:36:34 by vfuster-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*-- Variable Globale --*/
extern int	g_last_execution_code;
...
int			error_command(char *command, char *detail, char *error_message,
				int error_nb);
void		error_message(char *errmsg, char *detail, int quotes);
